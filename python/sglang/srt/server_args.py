    ...
    def _handle_other_validations(self):
        ...
        if (
            ...
            if self.pp_size > 1:
                ...
                # The fork's opt-in escape hatch predates upstream narrowing this
                # from "any hierarchical cache" to the L2 + write-back case, so it
                # now only covers the configurations upstream still refuses.
